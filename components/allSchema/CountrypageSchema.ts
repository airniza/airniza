...
export function CountrypageSchema({
  ...
  return [
    // WebPage Schema
    {
      ...
      description: `The current air quality in ${Country} is ${Aqi} (${Condition}). Main pollutant is ${mainPollutant}, temperature ${Temp}°C, humidity ${Humidity}%, and wind speed ${Ws} km/h.`,
