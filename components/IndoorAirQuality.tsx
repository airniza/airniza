    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {aqi <= 50 ? (
        ...
        <>
          ...
          <p className="mt-2">
            In such situations, residents of {place} should make efforts to improve indoor air quality by reducing sources of pollution and maximizing the flow of cleam air. Avoid smoking inside the house, use an exhaust fan in the kitchen for proper ventilation and use HEPA filters to clean the air. Small steps like placing indoor plants can also help reduce indoor air pollution to some extent. Dust particles and allergens that cause breathing problems can be removed by regularly cleaning mattresses and carpets. Drinking enough water, exercising and getting proper rest are healthy lifestyle habits that help protect against the effects of pollution levels. With these small efforts the people of {place} can improve indoor air quality and protect their health.
