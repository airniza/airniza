...
<svg width="900" height="350" xmlns="http://www.w3.org/2000/svg">
 <defs>
  ...
  <text x="255" y="155" text-anchor="middle" fill="white" font-size="52" font-weight="800" font-family="Arial, Helvetica, sans-serif" opacity="0.95">AQI</text>

  <text x="255" y="250" text-anchor="middle" fill="white" font-size="100" font-weight="900" font-family="Arial, Helvetica, sans-serif">${aqi}</text>

  <text x="450" y="220" fill="white" font-size="60" font-weight="900" font-family="Arial, Helvetica, sans-serif" style="text-transform: uppercase; letter-spacing: -2px;">${text}</text>
</svg>
`);
}
...
<svg width="1200" height="300" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="600" y="25" text-anchor="middle" fill="white" font-size="20" font-weight="700" font-family="Arial, Helvetica, sans-serif" style="letter-spacing: 4px; text-transform: uppercase;">
    AIR QUALITY INDEX • PM2.5
  </text>
  <rect x="400" y="45" width="400" height="1.5" fill="white" fill-opacity="0.3" />
  
  <text x="600" y="90" text-anchor="middle" fill="white" font-size="40" font-weight="800" font-family="Arial, Helvetica, sans-serif">
    ${cityName}, ${stateName}
  </text>
</svg>
`);
